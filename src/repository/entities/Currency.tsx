...
export class Currency  {
    ...
    public static MATIC = new Currency ("MATIC", 18, new BigNumber(0), ChainType.POLYGON, null, MATIC) ;
    ...
    constructor(symbol: string, decimals: number, value: BigNumber, chain: ChainType, address: any, logo: any, )  {
